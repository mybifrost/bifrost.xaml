...
namespace Bifrost.XAML.Phone.Controls
{
    ...
    public class RingSlice : Path
    {
        ...
        {
            if (sizeChangedEventArgs.PreviousSize != sizeChangedEventArgs.NewSize)
                UpdatePath();
        }
        ...
        private void UpdatePath()
        {
            ...
            else if ((EndAngle - StartAngle) % 360 == 0)
            {
                // full circle
                pathGeometry.Figures.Add(FigureForArc(center, innerRadius, outerRadius, 0, 180));
                pathGeometry.Figures.Add(FigureForArc(center, innerRadius, outerRadius, 180, 360));
            }
            else
            {
                pathGeometry.Figures.Add(FigureForArc(center, innerRadius, outerRadius, StartAngle, EndAngle));
            }
        ...
        private PathFigure FigureForArc(Point center, double innerRadius, double outerRadius, double startAngle, double endAngle)
        {
